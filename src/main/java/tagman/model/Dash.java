...
public class Dash extends GameObject {
   ...
   * 
   * @param x
   *          The X position that the dash should start
   *          at. (Y defaults to 0.)
   * @param speed
   *          The amount of pixels a dash should move
   *          every frame.
   * @param startTime
   *          The time at which the dash should start
   *          moving (milliseconds).
   */
   ...
   * 
   * @param currentTime
   *          The amount of milliseconds elapsed since the
   *          start of the game.
   */
