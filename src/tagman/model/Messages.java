...
public class Messages {
  ...
  public static String createWelcomeMessage (int level) {
    String[] message = {
        "Welome to TagMan!", "Move with Arrows or Numpad", EMPTY_LINE
    };
  ...
  public static String createStartLevelMessage (int level) {
    String[] message = {
        "LEVEL " + level, EMPTY_LINE, "Press S to Start"
    };
  ...
  public static String createEndLevelMessage (int levelScore) {
    String[] message = {
        "TagMan Finished!", "Level Score: " + levelScore, EMPTY_LINE, "Press L to Continue"
    };
    return assembleMessage(message);
  }
  ...
  public static String createEndGameMessage (boolean won, int totalScore) {
    ...
    String[] message = {
        "GAME OVER", reason, EMPTY_LINE, "Total Score: " + totalScore, EMPTY_LINE, "Press ESC to Exit"
    };
